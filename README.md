...
- **strawberry**, a framework that mostly uses SSE to update the frontend.
- **booksao**, rent a star (influencer, singer, dancer, etc.) for your event.
- **Fides**, a tribe-based (referral) social network where one member’s mistake gets the entire tribe banned.
- **BambooOnline**, grow a bamboo forest through crowdsourcing.
- **SnapCard**, a new way to send postcard.
- **The AI Pet Company**, a personal AI pet that learns and grows with you.
- **Auris**, music platform for indie artists.
